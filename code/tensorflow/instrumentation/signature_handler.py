...
class SignatureHandler:
    ...
    def check_var_tensor(self, v):
        ...
        # TODO: sparse tensors doesn't work this way.
...
def test():
    print(SignatureHandler().get_var_signature(1))
    print(SignatureHandler().get_var_signature(1.6))
    print(SignatureHandler().get_var_signature([3,3]))
    print(SignatureHandler().get_var_signature(np.array([3.5,3.6])))
    print(SignatureHandler().get_var_signature(tf.constant([3.5,3.6])))
